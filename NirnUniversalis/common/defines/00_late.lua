...
--Imperial City Coordinates : x2218 z1135
NDefines.NGame.START_DATE = "1444.11.11"
NDefines.NGame.END_DATE = "1821.1.2"

NDefines.NFrontend.CAMERA_LOOKAT_X = 2218 						-- Rotation point in main menu
NDefines.NFrontend.CAMERA_LOOKAT_Y = 0.0
NDefines.NFrontend.CAMERA_LOOKAT_Z = 1519.0
NDefines.NFrontend.CAMERA_LOOKAT_SETTINGS_X = 2218 				-- Rotation point in settings
NDefines.NFrontend.CAMERA_LOOKAT_SETTINGS_Y = 0.0					-- Y is height
NDefines.NFrontend.CAMERA_LOOKAT_SETTINGS_Z = 1519.0
NDefines.NFrontend.CAMERA_START_X = 2218						-- Initial position in main menu
NDefines.NFrontend.CAMERA_START_Y = 800							-- Y is height
NDefines.NFrontend.CAMERA_START_Z = 1400.0
NDefines.NFrontend.CAMERA_END_X = 2218							-- Move to position in main menu
...
NDefines.NFrontend.CONTENT_POS_X = 2218
