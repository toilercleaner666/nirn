...
NNationDesigner = {
	...
	MANDATE_SUBCONTINENT_NAME = "cyrodiil_superregion", -- Name of the subcontinent where the Mandate will be given to the biggest nation by development when using random generated nations
},
